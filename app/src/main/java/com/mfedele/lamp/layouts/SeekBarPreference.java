...
public class SeekBarPreference extends Preference implements OnSeekBarChangeListener {
    ...
    private void setValuesFromXml(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mMaxValue = a.getInt(R.styleable.SeekBarPreference_android_max, DEFAULT_MAX_VALUE);
            mMinValue = a.getInt(R.styleable.SeekBarPreference_minVal, DEFAULT_MIN_VALUE);

            mUnitsLeft = getAttributeStringValue(a, R.styleable.SeekBarPreference_unitsLeft, "");
            String units = getAttributeStringValue(a, R.styleable.SeekBarPreference_units, "");
            mUnitsRight = getAttributeStringValue(a, R.styleable.SeekBarPreference_unitsRight, units);
